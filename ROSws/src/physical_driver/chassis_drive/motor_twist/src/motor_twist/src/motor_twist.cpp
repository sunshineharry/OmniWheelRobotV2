...
void motor_twist::step()
{
  ...
  memset(&(motor_twist_B.BusAssignment1.header.frame_id), 0, 128);
  memcpy( &(motor_twist_B.BusAssignment1.header.frame_id), "base_link", 10);

  motor_twist_B.BusAssignment1.header.frame_id_SL_Info.CurrentLength = 128;
  motor_twist_B.BusAssignment1.header.frame_id_SL_Info.ReceivedLength = 128;
